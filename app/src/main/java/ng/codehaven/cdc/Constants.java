...
public class Constants {
    ...
    public static final double VAT = 5;
    public static final double ETLS_PERCENTAGE = 0.5;
    ...
    public static final String APPLICATION_KEY = "JN7i5U6SkyPHu3P8KgEtqtRkhvPzm3x6uKiQeh9K";
    public static final String REST_KEY = "7yIx1MeTrImwuRbXWJGt6UxYX6ylWqlQxy0fw7m3";
